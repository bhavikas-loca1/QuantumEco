...
class OptimizedRoute(BaseModel):
    ...
    total_cost_usd: float = Field(..., ge=0, description="Total route cost")
...
class RouteOptimizationResponse(BaseModel):
    ...
    total_cost_usd: float = Field(..., ge=0, description="Total cost across all routes")
    ...
    optimization_method: str = Field(default="quantum_inspired", description="Optimization method used")
...
class BatchOptimizationResponse(BaseModel):
    ...
    total_processing_time_seconds: float = Field(..., ge=0, description="Total processing time for batch")
...
class MethodResult(BaseModel):
    ...
    optimization_time_seconds: float = Field(..., ge=0, description="Processing time")
