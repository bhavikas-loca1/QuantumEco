  ...
  return (
    ...
    <Box sx={{ 
      ...
      <Box sx={{
        ...
        <Box sx={{ flex: 1 }}>
          {/* ✅ CHANGED: Aligned title to the left */}
        ...
        <Box sx={{ px: { xs: 2, sm: 3, md: 4 }, mb: 3 }}>
          <Alert 
            ...
            sx={{ 
              ...
              p: 3,
              borderRadius: 2,
              backgroundColor: '#f4f7f4', // ✅ CHANGED: Light sage green
            }} 
      ...
      <Box sx={{ 
        ...
        >
          ...
          <Box sx={{ 
            ...
            {/* ✅ CHANGED: Card background to light sage green */}
            <Card sx={{ height: 500, width: '100%', backgroundColor: '#f4f7f4' }}>
        ...
        {walmartImpact && (
          <Box sx={{ width: '100%' }}>
            ...
            <Card
              sx={{
                background: '#f4f7f4', // ✅ CHANGED: Light sage green instead of gradient
                width: '100%'
              }}
            >
              <CardContent sx={{ p: 4 }}>
                ...
                <Box
                  sx={{
                    ...
                    gap: 2,
                    p: 3,
                    bgcolor: 'rgba(244, 247, 244, 0.8)', // ✅ CHANGED: Light sage green with transparency
                    borderRadius: 2,
                  }}
                >
